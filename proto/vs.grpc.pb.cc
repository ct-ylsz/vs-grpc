...
VsService::Stub::Stub(const std::shared_ptr< ::grpc::ChannelInterface>& channel, const ::grpc::StubOptions& options)
  ...
  , rpcmethod_ConfigFileSet_(VsService_method_names[5], options.suffix_for_stats(),::grpc::internal::RpcMethod::NORMAL_RPC, channel)
...
::grpc::Status VsService::Stub::ConfigFileSet(::grpc::ClientContext* context, const ::vs::ConfigFileSetReq& request, ::vs::ConfigFileSetResp* response) {
  return ::grpc::internal::BlockingUnaryCall< ::vs::ConfigFileSetReq, ::vs::ConfigFileSetResp, ::grpc::protobuf::MessageLite, ::grpc::protobuf::MessageLite>(channel_.get(), rpcmethod_ConfigFileSet_, context, request, response);
}

void VsService::Stub::async::ConfigFileSet(::grpc::ClientContext* context, const ::vs::ConfigFileSetReq* request, ::vs::ConfigFileSetResp* response, std::function<void(::grpc::Status)> f) {
  ::grpc::internal::CallbackUnaryCall< ::vs::ConfigFileSetReq, ::vs::ConfigFileSetResp, ::grpc::protobuf::MessageLite, ::grpc::protobuf::MessageLite>(stub_->channel_.get(), stub_->rpcmethod_ConfigFileSet_, context, request, response, std::move(f));
}

void VsService::Stub::async::ConfigFileSet(::grpc::ClientContext* context, const ::vs::ConfigFileSetReq* request, ::vs::ConfigFileSetResp* response, ::grpc::ClientUnaryReactor* reactor) {
  ::grpc::internal::ClientCallbackUnaryFactory::Create< ::grpc::protobuf::MessageLite, ::grpc::protobuf::MessageLite>(stub_->channel_.get(), stub_->rpcmethod_ConfigFileSet_, context, request, response, reactor);
}

::grpc::ClientAsyncResponseReader< ::vs::ConfigFileSetResp>* VsService::Stub::PrepareAsyncConfigFileSetRaw(::grpc::ClientContext* context, const ::vs::ConfigFileSetReq& request, ::grpc::CompletionQueue* cq) {
  return ::grpc::internal::ClientAsyncResponseReaderHelper::Create< ::vs::ConfigFileSetResp, ::vs::ConfigFileSetReq, ::grpc::protobuf::MessageLite, ::grpc::protobuf::MessageLite>(channel_.get(), cq, rpcmethod_ConfigFileSet_, context, request);
}

::grpc::ClientAsyncResponseReader< ::vs::ConfigFileSetResp>* VsService::Stub::AsyncConfigFileSetRaw(::grpc::ClientContext* context, const ::vs::ConfigFileSetReq& request, ::grpc::CompletionQueue* cq) {
  auto* result =
    this->PrepareAsyncConfigFileSetRaw(context, request, cq);
  result->StartCall();
  return result;
}
...
VsService::Service::Service() {
  ...
  AddMethod(new ::grpc::internal::RpcServiceMethod(
      ...
      ::grpc::internal::RpcMethod::NORMAL_RPC,
      new ::grpc::internal::RpcMethodHandler< VsService::Service, ::vs::ConfigFileSetReq, ::vs::ConfigFileSetResp, ::grpc::protobuf::MessageLite, ::grpc::protobuf::MessageLite>(
          [](VsService::Service* service,
             ::grpc::ServerContext* ctx,
             const ::vs::ConfigFileSetReq* req,
             ::vs::ConfigFileSetResp* resp) {
               return service->ConfigFileSet(ctx, req, resp);
             }, this)));
  AddMethod(new ::grpc::internal::RpcServiceMethod(
...
::grpc::Status VsService::Service::ConfigFileSet(::grpc::ServerContext* context, const ::vs::ConfigFileSetReq* request, ::vs::ConfigFileSetResp* response) {
  (void) context;
  (void) request;
  (void) response;
  return ::grpc::Status(::grpc::StatusCode::UNIMPLEMENTED, "");
